...
from time import time as timer #імпортуємо функцію для засікання часу, щоб інтерпретатор не шукав цю функцію в pygame модулі time
...
img_hero = "ship.jpg"  #герой
img_bullet = "bullet.jpg" #куля
img_enemy = "monsters.jpg"  #ворог
img_ast = "asteroid.jpg" #астероїд
...
for i in range(1, 2):
    asteroid = Enemy(img_ast, randint(30, win_width - 30), -40, 80, 50, randint(1, 6))
